...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-flyerflix-black flex flex-col items-center justify-center p-4">
      ...
      <div 
        ref={formRef}
        className="w-full max-w-md bg-[#1e1e1e] p-8 rounded-lg shadow-lg border border-white/10"
      >
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="space-y-1 animate-fade-in" style={{animationDelay: '100ms'}}>
            ...
            <Input 
              ...
              className="bg-[#333] border-[#444] text-white min-h-[44px] animated-input" 
              value={formData.name} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative animate-fade-in" style={{animationDelay: '300ms'}}>
            <div className="space-y-1">
              ...
              <div className="relative">
                <Input 
                  ...
                  placeholder="••••••••" 
                  className="bg-[#333] border-[#444] text-white pr-10 min-h-[44px] animated-input" 
            ...
            <button 
              type="button" 
              className="absolute right-3 top-8 transform text-white/70 hover:text-white transition-all duration-200 md:right-[calc(50%+10px)]" 
          ...
          <div className="space-y-3 pt-2 animate-fade-in" style={{animationDelay: '400ms'}}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div 
                className={`p-4 border rounded-lg cursor-pointer transition-all duration-300 hover:shadow-lg ${
                  formData.planChoice === 'free' 
                    ? 'border-flyerflix-red bg-[#2a1b1b]' 
                    : 'border-white/20 bg-[#222] hover:bg-[#272727]'
                }`} 
              ...
              <div 
                ...
                onClick={() => handlePlanChoice('ultimate')}
              >
          ...
          <div className="flex items-center space-x-2 pt-2 animate-fade-in" style={{animationDelay: '500ms'}}>
            <Checkbox 
              id="acceptTerms" 
              name="acceptTerms" 
          ...
          <Button 
            type="submit" 
            className="w-full bg-flyerflix-red hover:bg-red-700 mt-6 min-h-[44px] transition-all duration-300 hover:shadow-lg active:scale-98 animate-fade-in" 
